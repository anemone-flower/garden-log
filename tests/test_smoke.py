...
from garden_log.cli import main
from garden_log.models import Note, ProjectState, Task
from garden_log.cli import demo_state
from garden_log.storage import load_state, save_state
from garden_log.models import generate_short_id
from garden_log.validation import normalize_tags, require_text, validate_task_status
from garden_log.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
